...
/**
 * Renderuje mapę gry na ekranie
 * Funkcja odpowiada za:
 * - Wczytanie tekstur mapy
 * - Renderowanie wszystkich elementów mapy:
 *   - ścian (z odpowiednimi teksturami w zależności od sąsiadów)
 *   - drzwi
 *   - kulek (pellets)
 *   - energizerów
 *
 ...
 */
void render_map(const std::array<std::array<Cell, MAP_HEIGHT>, MAP_WIDTH> &i_map, sf::RenderWindow &i_window) {
    sf::Sprite sprite;
