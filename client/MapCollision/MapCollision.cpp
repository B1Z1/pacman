...
/**
 * Sprawdza kolizję z elementami mapy w określonej pozycji
 * @param i_collect_pellets Czy należy zbierać kulki podczas sprawdzania kolizji
 * @param i_use_door Czy można przechodzić przez drzwi (używane przez duchy)
 * @param i_x Pozycja X do sprawdzenia
 * @param i_y Pozycja Y do sprawdzenia
 * @param i_map Referencja do mapy gry
 * @return true jeśli wystąpiła kolizja ze ścianą, false w przeciwnym razie
 */
